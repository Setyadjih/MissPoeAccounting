...
"}")
    ...
    def retranslateUi(self, pembelian):
        ...
        self.unit_combo.setItemText(0, QCoreApplication.translate("pembelian", u"Ctn/pack", None))
        self.unit_combo.setItemText(1, QCoreApplication.translate("pembelian", u"pcs", None))
        self.unit_combo.setItemText(2, QCoreApplication.translate("pembelian", u"Kg", None))
